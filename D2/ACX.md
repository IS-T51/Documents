...
- L'utente autenticato può aggiungere una proposta di attività al catalogo o può aggiungere direttamente un'attività se è un amministratore (**RF14** e **RF18**), o modificare una propria proposta di attività se autenticato o una qualsiasi attività del catalogo se amministratore (**RF15** e **RF19**).
...
- In concomitanza alle richieste di modifica dei campi attività o proposta di attività da parte di un utente autenticato o di un amministratore (**RF15** e **RF19**), il sistema inoltrerà tale richiesta a MongoDB; mentre in concomitanza alle richieste di creazione di una nuova attività o proposta di attività da parte di un utente autenticato o di un amministratore (**RF14** e **RF18**), il sistema chiederà prima a MongoDB di verificare che l'attività o proposta non sia già presente nel catalogo, MongoDB fornirà la risposta, e in caso affermativo il sistema inoltrerà la richiesta di creazione a MongoDB.
- In concomitanza alle richieste di visualizzazione dell'elenco delle proprie liste di attività da parte di un utente autenticato (**RF11**), il sistema inoltrerà a MongoDB tale richiesta e MongoDB fornirà l'elenco al sistema; in concomitanza alla richiesta di creazione di una nuova lista di attività da parte di un utente autenticato (**RF7**), il sistema chiederà prima a MongoDB di verificare che la lista non sia già presente tra quelle dello specifico utente, MongoDB fornirà la risposta, e in caso affermativo il sistema inoltrerà la richiesta di creazione a MongoDB; mentre in concomitanza a qualsiasi altra richiesta di manipolazione delle proprie liste di attività da parte di un utente autenticato (**RF** da **8** a **10**), il sistema si limiterà a inoltrare tali richieste a MongoDB.
